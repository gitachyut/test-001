...
let { GoogleAuth, OAuth2Client } = require('google-auth-library');
...
] //you can add more scopes according to your permission need. But in case you chang the scope, make sure you deleted the ~/.credentials/sheets.googleapis.com-nodejs-quickstart.json file
...
const TOKEN_PATH = './credentials/token_new.json'; //the file which will contain the token
